...
class VestingBasicsTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # mining 1000 blocks, total budget: 14949.77187643 BTC
        for i in range(0,2):
        ...
        self.log.info("watching BTC general balance")
        params = str([""]).replace("'",'"')
        out = tradelayer_HTTP(conn, headers, False, "getbalance",params)
        self.log.info(out)
        assert_equal(out['error'], None)

        adminAddress = '2MuSYaHzx5Ch1UpPJ2TzuwZcNs8LxewAZce'
        privkey = 'cReUYNpLeMi7faziq3dpddxYD7UZezwtz7rsDv8XyCA7uA2VAMkr'
        ...
        self.log.info("Funding addresses[3] with 12000 BTC")
        amount = 2000
        ...
        # 200 BTC implies release 7.5% of ALLs from unvested to balance
        # NOTE: In regtest 200 BTC volume is equivalent to 20000 (x100) BTCs in testnet or mainnet
        self.log.info("Creating BTC volume in DEx")
        ...
        self.log.info("Checking BTC Volume")
        ...
        assert_equal(out['result']['url'], 'www.tradelayer.org')
        assert_equal(out['result']['divisible'], True)
        assert_equal(out['result']['issuer'], '2MuSYaHzx5Ch1UpPJ2TzuwZcNs8LxewAZce')
        assert_equal(out['result']['activation block'], 100)
        assert_equal(out['result']['bitcoin volume'], '200.00000000')
        ...
        # 400 BTC implies release 15.05% of ALLs from unvested to balance
        # Remember: 400 BTCs in regtest is 40000 (x100) BTCs in testnet/mainnet
        self.log.info("Sending a DEx sell tokens offer")
        ...
        assert_equal(out['result']['issuer'], '2MuSYaHzx5Ch1UpPJ2TzuwZcNs8LxewAZce')
        assert_equal(out['result']['activation block'], 100)
        assert_equal(out['result']['bitcoin volume'], '400.00000000')
